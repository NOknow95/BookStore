	...
	<div id="main">
		<table>
				...
				<c:otherwise>
					...
					<c:forEach items="${page.data}" var="book">
						<tr>
							...
							<td><a class="delA" href="manager/BookManagerServlet?method=delBook&bookId=${book.id }">删除</a>
							</td>
						</tr>
					</c:forEach>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><a href="pages/manager/book_edit.jsp">添加图书</a>
				</td>
			</tr>
		</table>
